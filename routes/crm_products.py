    ...
    try:
        ...
        if product:
            ...
            product = Product(
                ...
                mattress_height_cm=data.get('mattress_height_cm'),
                mattress_fabric_type=data.get('mattress_fabric_type'),
                has_double_pillow=data.get('has_double_pillow', False),
                has_moisture_breathers=data.get('has_moisture_breathers', False),
                has_side_handles=data.get('has_side_handles', False),
